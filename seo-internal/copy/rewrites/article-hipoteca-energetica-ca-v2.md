# Rewrite CA v2 · article-hipoteca-energetica · esmena editorial v1.1

> Versió 2 amb les tres esmenes aplicades: cap guió llarg, registre adult-professional, prosa per defecte. Adaptació al patró del v2 de la nota de premsa Sabadell, amb un to més argumentat i menys didàctic.
...
```html
<title>Hipoteca verda · què és i quan val la pena per a una Passivhaus | PAPIK</title>
<meta name="description" content="La hipoteca verda i el cost ocult de climatitzar la llar. Com una casa Passivhaus redueix fins al 90% la despesa energètica anual i transforma el cost total de propietat.">
<link rel="canonical" href="https://papik.cat/article-hipoteca-energetica">
...
<meta property="article:section" content="Finançament i hipoteques">
```
...
Hipoteca verda: el cost que paga cada mes la casa que no l'ha demanat

## BYLINE

```
Equip de PAPIK Group · [Data publicació] · Reading time aproximat 8 min
```

## INTRO

Tothom comprèn què és una hipoteca bancària: un préstec que es liquida en quotes mensuals al llarg de vint o trenta anys. Existeix, però, un segon deute, més silenciós i sovint més onerós a llarg termini, que acompanya qualsevol habitatge mentre es manté en ús. És el cost recurrent de mantenir el confort interior de la llar: calefacció a l'hivern, refrigeració a l'estiu, aigua calenta sanitària, ventilació. La literatura especialitzada l'anomena hipoteca energètica, i a Europa el sector financer ja ha respost amb un producte específic, la hipoteca verda.

La diferència entre les dues és estructural. La hipoteca financera té un termini definit i un dia s'acaba. La hipoteca energètica d'un habitatge ineficient, en canvi, no s'extingeix. Mentre vostè hi visqui, la pagarà mes rere mes, condicionada per un preu de l'energia que en els darrers anys ha mantingut una trajectòria ascendent. Aquest article descriu el cost real d'aquesta hipoteca invisible, les xifres que el delimiten, i com l'estàndard Passivhaus i la hipoteca verda redueixen ambdues partides simultàniament.

---

## H2 · 1. Què és la hipoteca energètica i per què importa
...
## H2 · 3. El cost total de propietat: la xifra que realment importa
...
## H2 · 5. Hipoteca verda: quan el sistema financer reconeix l'eficiència
...
## H2 · 6. La decisió financera, no només ecològica

Sovint l'eficiència energètica es presenta com una opció ètica o mediambiental. Ho és, certament. Però sobretot és una decisió financera racional sustentada en xifres mesurables. Cada euro invertit en aïllament continu, hermeticitat verificada i ventilació amb recuperació de calor genera un retorn quantificable i creixent al llarg del temps, amortitzat pels estalvis operatius i ampliat per la revalorització del bé i les condicions de finançament preferents.

A PAPIK, quan presentem un pressupost a un client, sempre incloem la projecció del cost total de propietat a 30 anys, juntament amb l'escenari de finançament associat. Els números expliquen la realitat: la casa que aparentment és més cara resulta ser, integrant tot el cicle de vida, la més econòmica que vostè pot construir o adquirir.

---

## H2 · 7. Preguntes freqüents

### En què es diferencia una hipoteca verda d'una hipoteca convencional?
...
Sí. En projectes de rehabilitació, el finançament verd es pot combinar amb les ajudes NGEU dels programes 3, 4 i 5. PAPIK estructura la combinació òptima de capital propi, subvenció pública i finançament verd durant la fase de projecte.

### Es publiquen aquí les condicions exactes de la hipoteca verda?

No. Les condicions concretes són privades, exclusives per a cada client, i es comuniquen individualment durant el procés d'avaluació. Aquest article descriu el marc conceptual i tècnic, no condicions comercials.

### Una rehabilitació energètica també redueix la hipoteca energètica?

Sí. Una rehabilitació EnerPHit ben dimensionada pot reduir la demanda de climatització en un 70 a 90% respecte de l'estat previ, amb un horitzó d'amortització acotat per la combinació d'estalvi operatiu i ajudes públiques disponibles.

---

## CIERRE

Si està valorant un projecte de construcció, promoció o rehabilitació amb PAPIK i vol explorar com l'estàndard Passivhaus i la hipoteca verda redueixen el seu cost total de propietat a Catalunya, podem incorporar aquesta projecció a la fase de planificació financera. La conversa inicial es fa sense compromís i orienta sobre l'estructura que millor encaixa amb el seu cas.

Sol·licitar informació sobre finançament verd: contacte general de PAPIK.
...
[Com calcular el pressupost d'una casa passiva](/article-pressupost-casa-passiva)

[Els cinc principis del Passivhaus](/article-principis-passivhaus)

[Construcció · de zero a clau en mà](/construccio)

[Promoció · cases ja construïdes o amb entrega tancada](/promocio)

[Rehabilitació energètica i Next Generation EU](/rehabilitacio)

---

## DISCLAIMER

Aquest contingut és informatiu. Cap menció d'entitats financeres no constitueix oferta vinculant ni assessorament financer regulat. Les condicions hipotecàries concretes es defineixen entre l'entitat financera i el client en funció del seu perfil de risc, en línia amb la normativa hipotecària espanyola vigent.

---

## Canvis respecte a v1

Tots els guions llargs eliminats. Estructura adaptada al patró v2 de la nota de premsa Sabadell: H2 numerats, FAQ amb H3, intro doble paràgraf argumentatiu, registre adult-professional amb tractament de vostè. Substitució de "hipoteca energètica" per "hipoteca verda" com a producte financer (es manté "hipoteca energètica" només com a concepte teòric del cost operatiu invisible). Termes tècnics invariables: Passivhaus, EnerPHit, blower-door, CTE. Cap xifra concreta de tipus, LTV ni terminis hipotecaris. Cross-links interns afegits a articles relacionats i a les tres línies de servei. Disclaimer regulatori financer reforçat.
