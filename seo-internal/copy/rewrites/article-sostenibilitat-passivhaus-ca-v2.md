# Rewrite CA v2 · article-sostenibilitat-passivhaus · esmena editorial v1.1

> Versió 2 amb estil v1.1: registre adult, sense guions llargs, prosa argumentada, marc tècnic ampliat (EN 15978, LCA, EPD, ESG).
...
Passivhaus i sostenibilitat: marc tècnic, LCA i decisions verificables
...
L'indicador més utilitzat és el GWP (Global Warming Potential), expressat en kgCO₂eq per metre quadrat útil. Una casa convencional construïda segons el codi tècnic vigent sol situar-se entre 800 i 1.200 kgCO₂eq/m² al llarg dels seus cinquanta anys d'operació. Una casa Passivhaus ben dissenyada amb materials de baixa empremta pot reduir aquest valor entre un 40% i un 60%, i una construcció amb estructura de fusta CLT i aïllaments biobasats pot situar-se per sota dels 300 kgCO₂eq/m² nets gràcies al carboni emmagatzemat.

Quan algú parla de "casa sostenible" sense mencionar EN 15978, ni LCA, ni EPD (Environmental Product Declaration), la conversa és comercial i no tècnica.
...
## H2 · 4. Materials, traçabilitat i certificacions formals
...
## H2 · 5. Operació: per què Passivhaus segueix sent decisiu
...
## H2 · 6. Bioclimatisme mediterrani i durabilitat a cent anys
...
## H2 · 7. ESG: sostenibilitat com a actiu patrimonial
...
## H2 · 8. Què pot exigir vostè a un projecte sostenible

Si està valorant una obra nova o una rehabilitació i vol assegurar-se que la dimensió sostenible és real i no decorativa, hi ha cinc preguntes que separen un projecte tècnic d'un projecte de fullet.

La primera és si el projecte aporta un càlcul LCA segons EN 15978, fet amb una eina reconeguda (PHPP, OneClick LCA, WUFI, EnergyPlus) i amb resultat expressat en kgCO₂eq/m². La segona és si els materials principals (estructura, aïllament, fusteries) tenen EPD vigents. La tercera és si la fusta està certificada FSC o PEFC, amb cadena de custòdia documentada. La quarta és si l'edifici està orientat a alguna certificació formal verificable (Passivhaus PHI, EnerPHit en rehabilitacions, LEED, BREEAM), o si simplement es presenta com a "casa sostenible" sense compromís verificable. La cinquena és si el projecte preveu un horitzó de durabilitat de cinquanta o cent anys, amb un detall constructiu coherent amb aquest horitzó.

Si totes cinc respostes són sòlides, el projecte té sostenibilitat real. Si manquen tres o més, el que hi ha és publicitat.

---

## H2 · 9. Preguntes freqüents

### Quina diferència hi ha entre "casa eficient" i "casa sostenible"?

Una casa eficient és la que consumeix poca energia en operació. Una casa sostenible considera totes les fases: materials, construcció, ús, final de vida. Tota Passivhaus ben dissenyada és eficient, però només ho és sostenible si es complementa amb decisions materials i de durabilitat coherents.

### El càlcul LCA encareix molt el projecte?
...
### Els materials biobasats són segurs en cas d'incendi?

Els aïllaments com la cel·lulosa insuflada o el suro projectat tenen comportament al foc certificat segons normativa europea (Euroclasses) i, combinats amb plaques tipus Fermacell o guix laminat, ofereixen protecció equivalent o superior als sistemes minerals tradicionals. La certificació de cada producte ho documenta de manera específica.

### Com puc verificar les afirmacions ambientals d'un constructor?

Demanant certificacions formals (Passivhaus PHI, EnerPHit, FSC, PEFC, LEED, BREEAM), EPD dels materials principals, càlcul LCA segons EN 15978 i resultat de la prova d'estanquitat (Blower Door). Si tot això manca, les afirmacions són publicitat.
...
[Tecnologies clau d'una casa Passivhaus](/article-tecnologies-passivhaus)

---

## Canvis respecte a v1

Tots els guions llargs eliminats. Marc original (Passivhaus + bioclimatisme + numeret K-Codines) substituït per un marc tècnic ampliat: EN 15978, LCA, GWP, EPD, FSC/PEFC, EnerPHit, ESG i taxonomia europea. Llistats verticals convertits a paràgrafs argumentats. Registre elevat amb tractament de "vostè". Cross-links interns afegits a /article-petjada-ecologica, /construccio, /rehabilitacio, /eskimohaus i articles relacionats. Word count: aproximadament 1.700 paraules.
