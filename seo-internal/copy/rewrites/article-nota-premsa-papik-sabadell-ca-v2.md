# Rewrite CA v2 · article-nota-premsa-papik-sabadell · esmena editorial v1.1

> Versió 2 amb les tres esmenes aplicades: cap guió llarg, registre adult-professional, prosa per defecte (llistats només en casos específics).
...
```html
<title>Hipoteca verda per a Passivhaus · acord PAPIK i Banc Sabadell | PAPIK</title>
<meta name="description" content="Què és una hipoteca verda i com finança una casa Passivhaus. PAPIK i Banc Sabadell formalitzen un acord per oferir aquest tipus de finançament als clients de PAPIK.">
<link rel="canonical" href="https://papik.cat/article-nota-premsa-papik-sabadell">
...
Hipoteca verda per a Passivhaus: l'acord entre PAPIK i Banc Sabadell

## BYLINE

```
Equip de PAPIK Group · [Data publicació] · Reading time aproximat 7 min
```
...
## H2 · 1. Què és una hipoteca verda
...
## H2 · 2. L'acord PAPIK i Banc Sabadell
...
### Compatibilitat amb ajudes públiques
...
## H2 · 4. A qui s'adreça aquest acord
...
### Quines són les condicions concretes de la hipoteca verda?
...
### Tinc garantida l'aprovació de la hipoteca?
...
### Puc usar aquesta opció amb una rehabilitació energètica?
...
### L'acord és exclusiu? Puc negociar amb altres entitats?
...
[Hipoteca energètica · què és i quan val la pena](/article-hipoteca-energetica)
...
Aquest contingut és informatiu. La menció de l'acord PAPIK i Banc Sabadell no constitueix oferta vinculant de finançament. Les condicions hipotecàries concretes es defineixen entre l'entitat financera i el client en funció del seu perfil de risc, en línia amb la normativa hipotecària espanyola vigent.
...
Article (cf. `schemas/04-article.json`) amb `articleSection: "Finançament i hipoteques"`. NO usar `FinancialProduct` schema, per la mateixa raó que a `/patrimonis`: podria interpretar-se com a publicitat de producte financer regulat. Afegir `BreadcrumbList` (Inici, Blog, Finançament, Sabadell).

### Privacitat aplicada

Cap condició hipotecària concreta publicada (LTV, terminis, percentatges). El text comunica que les condicions són privades i exclusives. Cap identificació de clients específics. Cap xifra de volumen comercial entre PAPIK i Sabadell.

### Canvis respecte a v1

Tots els guions llargs eliminats. Llistats verticals convertits a prosa argumentada (excepte els 3 perfils de client del bloc 4 i les preguntes de la FAQ del bloc 6, que mantenen estructura H3 + paràgraf perquè responen a unitats discretes amb subheaders propis). Frases de tipus didàctic eliminades. Registre elevat: vocabulari més tècnic-financer, frases més argumentades, menys telegràfiques.
